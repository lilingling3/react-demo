 ...
 * @param cb
 */
exports.queryOnce = function(cfg, sql, args, cb){
 ...
 *
 * preHandler(selfOp, results, opMap)
 * @param cb
 */
exports.queryWithTransaction = function(operations, cb){
 ...
 * @param cb
 */
exports.insert = function(tableName, toInsert, returnFields, cb){
 ...
 * @param cb
 */
exports.insertBatch = function(tableName, toInserts, returnFields, cb){
 ...
 * @param cb
 */
exports.update = function(tableName, filter, toUpdate, returnFields, cb){
  pgManager.update(tableName, filter, toUpdate, returnFields, cb);
};

exports.updateBatch = function(tableName, toUpdates, filterKey, returnFields, cb){
 ...
 * @param cb
 */
exports.select = function(tableName, filter, fields, cb){
 ...
 * @param cb
 */
exports.remove = function(tableName, filter, cb){
