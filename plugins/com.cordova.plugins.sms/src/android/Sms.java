package com.cordova.plugins.mysms;
		...
		cordova.getThreadPool().execute(new Runnable() {
			...
			public void run() {
				try {
					...
					callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.ERROR, "SMS not supported on this platform" + ex.toString()));
					return;
				}
			}
		});
